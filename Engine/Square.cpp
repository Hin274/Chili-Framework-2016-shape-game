...
void Square::Draw(Graphics& gfx) const
{
	...
	gfx.PutPixel(x_int + 2, y_int + 0, 255, 255, 0);
	...
	gfx.PutPixel(x_int + 8, y_int + 0, 255, 255, 0);
	gfx.PutPixel(x_int + 9, y_int + 0, 255, 255, 0);
	gfx.PutPixel(x_int + 10, y_int + 0, 255, 255, 0);
	gfx.PutPixel(x_int + 10, y_int + 1, 255, 255, 0);
	gfx.PutPixel(x_int + 10, y_int + 2, 255, 255, 0);
	...
	gfx.PutPixel(x_int + 10, y_int + 8, 255, 255, 0);
	gfx.PutPixel(x_int + 10, y_int + 9, 255, 255, 0);
	...
	gfx.PutPixel(x_int + 0, y_int + 8, 255, 255, 0);
	...
	gfx.PutPixel(x_int + 0, y_int + 2, 255, 255, 0);
	gfx.PutPixel(x_int + 0, y_int + 1, 255, 255, 0);
	gfx.PutPixel(x_int + 0, y_int + 0, 255, 255, 0);
}
...
void Square::Control(const Keyboard& kbd,float dt)
{
	Vec2 vel(0.0f, 0.0f);
	pos.x = pos.x + vel.x;
	pos.y = pos.y + vel.y;
...
void Square::Control(const Mouse& mouse, float dt)
{
